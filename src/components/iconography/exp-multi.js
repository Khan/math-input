    ...
    render() {
        return <svg width="48px" height="48px" viewBox="0 0 48 48" version="1.1">
            <g id="Math-Input" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                <g id="[Assets]-Math-Input" transform="translate(-1204.000000, -902.000000)">
                    <g id="math_keypad_icon_exponent_multi" transform="translate(1204.000000, 902.000000)">
                        <g id="icon">
                            ...
                            <rect id="exponent" fill={this.props.primaryColor} opacity="0.3" transform="translate(31.000000, 26.000000) scale(1, -1) translate(-31.000000, -26.000000) " x="28" y="25" width="6" height="2" rx="1"></rect>
                        </g>
                    </g>
                </g>
            </g>
